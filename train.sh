...
#python3 utils/features.py pack_audio_files_to_hdf5 --dataset_csv=$DATASET_CSV --workspace=$WORKSPACE --minidata
#python3 utils/features.py pack_audio_files_to_hdf5 --dataset_csv=$DATASET_CSV --workspace=$WORKSPACE
...
#CUDA_VISIBLE_DEVICES=0 python3 /home/kriti/panns_transfer_to_gtzan/pytorch/main.py train --workspace=$WORKSPACE --holdout_fold=1 --model_type="Cnn14" --augmentation='none' --loss_type=cce --epochs 100 --learning_rate=1e-4 --batch_size=8 --resume_iteration=0 --stop_iteration=100 --minidata --cuda
#CUDA_VISIBLE_DEVICES=0 python3 /home/kriti/panns_transfer_to_gtzan/pytorch/main.py train --workspace=$WORKSPACE --holdout_fold=1 --model_type="Cnn14" --augmentation='none' --loss_type=cce --epochs 100 --learning_rate=1e-5 --batch_size=8 --resume_iteration=0 --stop_iteration=100 --cuda
CUDA_VISIBLE_DEVICES=0 python3 /home/kriti/panns_transfer_to_gtzan/pytorch/main.py train --workspace=$WORKSPACE --holdout_fold=1 --model_type="Cnn10" --augmentation='none' --loss_type="cce" --epochs 20 --learning_rate=1e-3 --batch_size=8 --resume_iteration=0 --stop_iteration=100 --cuda
#####
