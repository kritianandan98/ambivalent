...
CUDA_VISIBLE_DEVICES=0 python3 /home/kriti/ambivalent/src/main.py train --workspace=$WORKSPACE --holdout_fold=1 --model_type="Cnn10" --augmentation='none' --loss_type="cce" --epochs 50 --learning_rate=1e-3 --batch_size=8 --resume_epoch=0 --cuda
#####
